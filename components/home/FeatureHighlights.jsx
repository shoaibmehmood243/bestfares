...
export default function FeatureHighlights() {
    ...
    return (
        <section id="features-highlights" className="py-10 px-4 md:px-10 bg-white">
                ...
                <div className={`grid grid-cols-1 md:grid-cols-2 gap-16 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <div>
                        <h3 className="text-[2.5rem] font-bold text-[#E91E63] leading-tight mb-6">
                            Trusted Travel Agency in Lahore
                        </h3>
                        <p className="text-gray-600 text-lg leading-relaxed italic">
                            As a leading <span className="font-bold underline decoration-gray-300 decoration-2 underline-offset-4">travel agency in Lahore</span>,
