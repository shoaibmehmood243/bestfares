    ...
    return (
        <div className="py-2 px-2 md:px-8 flex justify-normal items-start md:items-center gap-2 md:gap-0 border-b border-gray-300 flex-col md:flex-row">
            ...
            <div className="flex items-center gap-3 md:w-1/2">
                <a href="https://wa.me/9231114211111?text=Hello%20BestFares,%20I'm%20looking%20for%20" target="_blank" className="flex gap-1 items-center text-xs md:text-base border-0 md:border-l border-gray-300 md:pl-2">
